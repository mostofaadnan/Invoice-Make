...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <h5 style="color:#fff;">@lang('home.vat')/@lang('home.tax') @lang('home.payment')</h5>
    </div>
    <div class="card-body">
        ...
        <table id="mytable" class="table table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="15%"> @lang('home.vat') @lang('home.number') </th>
                    <th> @lang('home.payment') @lang('home.number')</th>
                    <th width="10%"> @lang('home.payment') </th>
                    <th width="10%"> @lang('home.description') </th>
...
<script>
    ...
    function DataTable() {
        ...
        table = $('#mytable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('report.vatpaymentQuery') }}",
                "data": {
                    type: type,
                    fromdate: fromdate,
                    todate: todate,
    ...
    function pdf(printconfirm) {
        ...
        if (tbody.children().length == 0) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('report.vatpaymentQueryPdf') }}",
                ...
                success: function(data) {
                    url = "{{ url('Report/vatpaymentPdfView')}}",
