...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <h5 style="color:#fff;">@lang("home.invoice") @lang("home.details")</h5>
    </div>
    <div class="card-body">
        ...
        <table id="mytable" class="table table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="10%"> @lang('home.invoice') @lang('home.number') </th>
                    <th> @lang('home.customer') </th>
...
<script>
    ...
    function DataTable() {
        ...
        table = $('#mytable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('report.invoicedetailsQuery') }}",
                "data": {
                    type: type,
                    fromdate: fromdate,
                    todate: todate,
    ...
    function pdf(printconfirm) {
        ...
        if (tbody.children().length == 0) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('report.invoicedetailsQueryPdf') }}",
                ...
                datatype: ("json"),
                success: function(data) {
                    url = "{{ url('Report/invoicedetailsPdfView')}}",
