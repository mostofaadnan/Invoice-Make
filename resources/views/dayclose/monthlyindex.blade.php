...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <div class="pull-left">
            @lang('home.dayclose') @lang('home.management')(@lang('home.monthly'))
        </div>
        <div class="pull-right">
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group" role="group" aria-label="First group">
                    <a type="button" class="btn btn-outline-danger" href="{{Route('dayclose.monthlycreate')}}">@lang('home.new')</i>
                    </a>
        ...
        <table id="mytable" class="table table-bordered" style="width:100%" cellspacing="0">
            <thead>
                <tr>
                    ...
                    <th class="text-center"> @lang('home.month') </th>
...
<script>
    ...
    function DataTable() {
        ...
        table = $('#mytable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('dayclose.loadallmonthly') }}",
                "data": {
                    fromdate: fromdate,
                    todate: todate
                },
