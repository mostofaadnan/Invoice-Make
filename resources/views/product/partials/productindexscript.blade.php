<script>
    ...
    $(document).on('click', "#dataedit", function() {
        ...
        url = "{{ url('Product/edit')}}" + '/' + dataid,
            window.location = url;
    });
    //data view
    $(document).on('click', "#datashow", function() {
        var dataid = $(this).data("id");
        url = "{{ url('Product/show')}}" + '/' + dataid,
            window.location = url;
    });
    //stock summerise
    $(document).on('click', "#stocksum", function() {
        var dataid = $(this).data("id");
        url = "{{ url('Product/openstock')}}" + '/' + dataid,
            window.location = url;
    });
    // data Delete
    ...
    $(document).on("click", "#inactive", function(event) {
        ...
        $.ajax({
            type: "post",
            url: "{{ url('Product/Inactive')}}" + '/' + dataid,
            data: {
                id: dataid,
            },
            datatype: ("json"),
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ url('Product/makeArchive')}}" + '/' + dataid,
                        success: function(data) {
                            table.ajax.reload();
                        },
                        error: function() {
