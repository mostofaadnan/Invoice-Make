<div class="card col-sm-10 profile-box">
    <div class="card-header">
        @lang('home.supplier') @lang('home.picture')
    ...
    <div class="card-body image-body">
        <div class="main-img-preview">
            ...
            <?php    } else { ?>
                <img class="thumbnail img-preview" src="{{asset('storage/app/public/supplier/'.$supplier->image)}}" style="width:200px; height: 200px" class="img-rounded" name="image" title="Preview Logo">
            <?php  }  ?>
