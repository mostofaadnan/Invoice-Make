            ...
            <tr>
                <td>
                    <select class="form-control" id="type">
                        ...
                        <option value="6">Vat Payment</option>
                        <option value="7">Salary Payment</option>
                        <option value="8">Cashin/Cashout</option>
                    </select>
                </td>
                <td>
        ...
        <table id="mytable" class="table table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th> @lang('home.type')</th>
                    <!-- th width="15%"> @lang('home.ref') @lang('home.number')</th> -->
...
<script>
    ...
    function DataTable() {
        ...
        table = $('#mytable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('report.cashdrawerQuery') }}",
                "data": {
                    type: type,
                    fromdate: fromdate,
                    todate: todate,
   ...
   $(document).on('click', '#pdfconforms', function() {
    ...
    function pdf(printconfirm) {
        ...
        if (tbody.children().length == 0) {
            ...
            $.ajax({
                type: "post",
                url: "{{ route('report.cashdrawerQueryPdf') }}",
                data: {
                    type: type,
                    typeid: typeid,
                    todate: todate,
                ...
                success: function(data) {
                    url = "{{ url('Report/cashdrawerPdfView')}}",
