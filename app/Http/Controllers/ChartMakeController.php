...
class ChartMakeController extends Controller
{
    ...
    {
        $apiinvoice = url('Chart/InvoiceBarchartMonthly');
    ...
    {
        $apipurchasemontrhly = url('Chart/PurchaseBarchartMonthly');
    ...
    {
        $apiCustomerPaymentMonthlyChart = url('Chart/CustomerPaymentMonthlychart');
    ...
    {
        $apiExpensesMonthlyChart = url('Chart/ExpensesMonthlyChart');
