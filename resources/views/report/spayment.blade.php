...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <h5 style="color:#fff;">@lang("home.supplier") @lang("home.payment")</h5>
    </div>
    <div class="card-body">
        ...
        <table id="mytable" class="table table-bordered" cellspacing="0" width="100%">
            ...
            <tfoot>
                <tr>
                    ...
                    <th id="totalpayment"> @lang('home.payment')</th>
