...
<div class="col-lg-12">
    <div class="card mainpanel">
        <div class="card-header card-header-section">
            <div class="pull-left">
                @lang('home.bank') @lang('home.name') @lang('home.management')
            </div>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-sm-8">
                    <div class="card">
                        <div class="card-header card-header-section">
                            <div class="pull-left">
                                @lang('home.bank') @lang('home.name') @lang('home.list')
                            </div>
                        </div>
                        <div class="card-body">
