        ...
        <div class="card">
            <div class="card-header card-header-section">
                <div class="row mb-3 mt-2">
                    <div class="col-sm-6">
                        @lang('home.user') @lang('home.profile')
                ...
                <div class="card-title mb-4">
                    <div class="d-flex justify-content-start">
                        <div class="image-container">
                            <img src="{{asset('storage/app/public/user/'.Auth::user()->image)}}" id="imgProfile" style="width: 150px; height: 150px" class="img-thumbnail" />
                            <div class="middle">
                                        ...
                                        <div class="table-wrapper-scroll-y my-custom-scrollbar">
                                            <table class="table table-bordered table-striped mb-0">
                                                <thead>
                                                    ...
                                                    <?php
                                                    $user = Auth::user();
                                                    foreach ($user->getAllPermissions() as $key => $permision) {
                                                    ?>
                                                        <tr>
                                                            <td>{{ $key+1 }}</td>
        ...
        $('#btnChangePicture').on('click', function() {
            ...
            if (!$('#btnChangePicture').hasClass('changing')) {
                ...
                if (fsize > 2000000) {
                    ...
                    $.ajax({
                        type: 'post',
                        url: "{{ url('UserProfile/ImageChange')}}",
                        data: form_data,
                        contentType: false,
                        cache: false,
                        processData: false,
