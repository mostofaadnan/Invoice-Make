...
<div class="input-group  mb-1">
    ...
    <input type="text" name="inputdate" id="dateinput" class="form-control">
...
<div class="input-group  mb-1">
    <div class="input-group-prepend">
        <span class="input-group-text" id="">@lang('home.type')</span>
    </div>
...
<div class="input-group mb-1">
    ...
    <textarea name="" class="form-control" id="remark" cols="5" rows="10" placeholder="@lang('home.remark')"></textarea>
</div>
