...
<div class="row">
    <div class="col-sm-7 form-single-input-section">
        <div class="card">
            <div class="card-header card-header-section">@lang('home.yearly') @lang('home.closing')</div>
            <div class="card-body">
                @include('partials.ErrorMessage')
                <form action="{{ route('dayclose.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="type" value="3">
                    <div class="input-group date mb-1" id="datepicker" data-date="" data-date-format="yyyy">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="">@lang('home.year')</span>
                        </div>
...
@include('dayclose.partials.daycloseyearlycreatescript')
@endsection