...
<link rel="stylesheet" href="{{asset('assets/css/datatables/elect.dataTables.min.css')}}">
...
<link rel="stylesheet" href="{{asset('assets/css/bootstrap/bootstrap-multiselect.css')}}">
<!-- Custom styling -->
<link href="{{asset('assets/css/custom/custom.min.css')}}" rel="stylesheet">
