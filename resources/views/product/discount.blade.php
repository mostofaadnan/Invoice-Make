        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="col-md-1 mb-1">
                    <label for="validationDefault01">@lang('home.tp')</label>
                    <input type="number" class="form-control" id="tp" placeholder="@lang('home.tp')">
                </div>
                <div class="col-md-1 mb-1">
                ...
                <table class="table table-bordered data-table" id="producttable" style="width:100%" cellspacing="0">
                    <thead>
                        <tr>
                            ...
                            <th width="15%"> @lang('home.barcode')</th>
                            <th> @lang('home.description')</th>
                            <th width="10%"> @lang('home.tp')</th>
    ...
    <script>
        ...
        $("#search").on('input', function() {
            ...
            if ($('#product option').filter(function() {
                ...
                var tp = $('#product').find('option[value="' + val + '"]').attr('data-tp');
        ...
        function addRowData() {
            ...
            $(".data-table tbody").append("<tr data-itemcode='" + itemcode + "' >" +
                ...
                "<td >" + barcode + "</td>" +
                "<td >" + productname + "</td>" +
                "<td align='right' contenteditable='true'>" + tp + "</td>" +
        ...
        function ProductDetails() {
            $.ajax({
                type: "get",
                url: "{{ url('Product/productgetlist')}}",
                datatype: ("json"),
                success: function(data) {
        ...
        function loadTableDetails(data) {
            ...
            data.forEach(function(value) {
                $(".data-table tbody").append("<tr data-itemcode='" + value.id + "' >" +
                    ...
                    "<td>" + value.barcode + "</td>" +
                    "<td>" + value.name + "</td>" +
                    "<td align='right'  contenteditable='true'>" + value.tp + "</td>" +
        ...
        function DataInsert() {
            ...
            $("#producttable TBODY TR").each(function() {
                ...
                item.mrp = row.find("TD").eq(4).text();
                item.discountprice = row.find("TD").eq(5).text();
