    ...
    <div class="card-body">
        ...
        <table class="table table-bordered" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <td>
                    <button type="button" class="btn btn-sm btn-info btn-lg" id="submitdate" name="button">@lang('home.submit')</button>
                </td>
            </tr>
        </table>
        <hr>
...
<script>
    ...
    function DataTable() {
        ...
        table = $('#mytable').DataTable({
            ...
            buttons: [{
                    extend: 'excel',
                    text: '<i class="fa fa-file-excel-o"></i>@lang("home.refresh")',
                ...
                {
                    text: '<i class="fa fa-envelope"></i>@lang("home.mail")',
    ...
    $("#submitdate").on('click', function() {
        if ($("#inputdateto").val() == "" || $("#inputdateto").val() == "" || customerid == 0) {
    ...
    $(document).on('click', '#sendconfirms', function() {
        var printconfirm = 3;
        pdf(printconfirm)
    ...
    function pdf(printconfirm) {
        ...
        if (tbody.children().length == 0) {
            ...
            $.ajax({
                ...
                datatype: ("json"),
                success: function(data) {
                    url = "{{ url('Report/customerstatementPdfView')}}"
                    if (printconfirm == 3) {
                        window.location = url;
                    } else {
