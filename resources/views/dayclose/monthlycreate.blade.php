...
<div class="row">
    <div class="col-sm-7 form-single-input-section">
        <div class="card">
            <div class="card-header card-header-section">@lang('home.monthly') @lang('home.closing')</div>
            <div class="card-body">
                ...
                <form action="{{ route('dayclose.store') }}" method="post" enctype="multipart/form-data">
                   ...
                   <!--  <div class="input-group date  mb-1" data-provide="datepicker" id="datetimepicker">
                    ...
                    <div class="input-group date mb-1" id="datepicker" data-date="" data-date-format="mm-yyyy">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="">@lang('home.month')</span>
                        </div>
...
@include('dayclose.partials.dayclosemonthlycreatescript')
@endsection