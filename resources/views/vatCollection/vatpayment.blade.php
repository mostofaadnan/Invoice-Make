...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <div class="pull-left">
            @lang('home.vat')/@lang('home.tax') @lang('home.payment')
        </div>
        <div class="pull-right">
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group" role="group" aria-label="First group">
                    <a type="button" class="btn btn-outline-danger" href="{{Route('vatpayment.paymentcreate')}}"> @lang('home.new')  @lang('home.vat')  @lang('home.payment')</i>
                    </a>
...
<script>
    ...
    $(document).on('click', '#pdfdata', function() {
        var id = $(this).data("id");
        url = "{{ url('Vat-Collections/vatPaymentPdf')}}" + '/' + id,
            window.open(url, '_blank');
    });
    $(document).on('click', '#print', function() {
        var id = $(this).data("id");
        url = "{{ url('Vat-Collections/vatpLoadPrintslip')}}" + '/' + id,
            window.open(url, '_blank');
    });
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ url('Vat-Collections/VatPaymentDelete')}}" + '/' + id,
                        success: function() {
