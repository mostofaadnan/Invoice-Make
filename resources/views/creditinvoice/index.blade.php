...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <div class="pull-left">
            @lang('home.invoice') @lang('home.management')(@lang('home.credit'))
        </div>
        <div class="pull-right">
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                <div class="btn-group" role="group" aria-label="First group">
                    <a type="button" class="btn btn-outline-danger" href="{{Route('creditinvoice.create')}}">@lang('home.new') @lang('home.invoice')</i>
                    </a>
                </div>
            </div>
        </div>
...
@include('creditinvoice.partials.invindexscript')
@endsection