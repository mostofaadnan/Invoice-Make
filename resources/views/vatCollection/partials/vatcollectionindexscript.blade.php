<script>
    ...
    $(document).on('click', '#datashow', function() {
        var id = $(this).data("id");
        url = "{{ url('Vat-Collections/show')}}" + '/' + id,
            window.location = url;
    });

    $(document).on('click', '#makepayment', function() {
        url = "{{ url('Vat-Collections/paymentcreate')}}",
            window.location = url;
    });
    $(document).on('click', '#print', function() {
        var id = $(this).data("id");
        url = "{{ url('Vat-Collections/LoadPrintslip')}}" + '/' + id,
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "post",
                        url: "{{ url('Vat-Collections/delete')}}" + '/' + id,
                        success: function() {
    ...
    $(document).on('click', '#pdfdata', function() {
        var id = $(this).data("id");
        url = "{{ url('Vat-Collections/pdf')}}" + '/' + id,
            window.open(url, '_blank');
    });
</script>