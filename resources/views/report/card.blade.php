...
<div class="card">
    ...
    <div class="card-header card-header-section">
        <h5 style="color:#fff;">@lang('home.card') @lang('home.payment')</h5>
    </div>
    <div class="card-body">
        ...
        <table id="mytable" class="table table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th> @lang('home.type')</th>
                    <th width="5%"> @lang('home.card') @lang('home.type')</th>
