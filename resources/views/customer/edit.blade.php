                ...
                <div class="row">
                    <div class="col-sm-6 form-left-portion">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input type="text" name="postalcode" class="form-control" id="exampleInputPassword2" placeholder="@lang('home.postal') @lang('home.code')" value="{{$customer->postalcode}}">
                        </div>
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input type="text" name="TIN" class="form-control" id="exampleInputPassword2" placeholder="@lang('home.tin')" value="{{$customer->tin}}">
                        </div>
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input type="text" name="tell_no" class="form-control" id="exampleInputPassword2" placeholder="T@lang('home.phone') @lang('home.no')" value="{{ $customer->tell_no}}">
                        </div>
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input type="text" name="fax_no" class="form-control" id="exampleInputPassword2" placeholder="@lang('home.fax') @lang('home.no')" value="{{ $customer->fax_no}}">
                        </div>
                        <div class="input-group mb-1">
                            <div class="input-group-prepend">
                        ...
                        <div class="input-group mb-1">
                            ...
                            <input type="website" name="website" class="form-control" id="exampleInputPassword2" placeholder="@lang('home.website')" value="{{ $customer->website }}">
                        </div>
                        <div class="input-group mb-1">
                            <div class="input-group-prepend">
                                <label class="input-group-text" for="inputGroupSelect01">@lang('home.description') </label>
                            </div>
                            <textarea name="description" class="form-control" cols="30" rows="2" placeholder="@lang('home.description') ">{{ $customer->description }}</textarea>
                        </div>
                    ...
                    <div class="col-sm-6 form-right-portion">
                        ...
                        <div class="input-group  mb-1">
                            ...
                            <select id="multi-select-category" class="multi-select" name="category[]" multiple="multiple">
                                ...
                                <option value="{{ $cat->id }}" @foreach($customer->CategoryName as $sublist) {{$sublist->category_id == $cat->id ? 'selected': ''}} @endforeach>{{ $cat->title }}</option>
                                @endforeach
                            </select>
                            <script>
                        ...
                        <div class="input-group  mb-1">
                            <div class="input-group date" data-provide="datepicker" id="datetimepicker2">
                                ...
                                <input type="text" name="openingdate" id="startDate" class="form-control" value="{{ $customer->openingDate }}">
