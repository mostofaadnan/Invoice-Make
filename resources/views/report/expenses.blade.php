        ...
        <table id="mytable" class="table table-bordered" cellspacing="0" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="15%"> @lang('home.expenses') @lang('home.number')</th>
                    <th> @lang('home.description')</th>
                    <th width="10%"> @lang('home.type') </th>
                    <th width="20%"> @lang('home.payment') </th>
            ...
            <tfoot>
                <tr>
                    ...
                    <th width="15%"> @lang('home.expenses') @lang('home.number')</th>
                    <th> @lang('home.description')</th>
                    <th width="20%"> @lang('home.type') </th>
                    <th width="20%"> @lang('home.payment') </th>
                    <th width="10%" id="totalamount"> @lang('home.amount')
                </tr>
            </tfoot>
        </table>
    </div>
...
<script>
    ...
    function DataTable() {
        ...
        table = $('#mytable').DataTable({
            ...
            "ajax": {
                "url": "{{ route('report.expensesQuery') }}",
                "data": {
                    type: type,
                    fromdate: fromdate,
                    todate: todate,
        ...
        if (tbody.children().length == 0) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    url = "{{ url('Report/expensesPdfView')}}",
