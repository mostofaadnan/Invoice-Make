<script type="text/javascript">
    ...
    function getUrl() {
        ...
        if (segment == 3) {
            ...
            PurchaseretunInfo(urlid);
        }
    }
window.onload=getUrl();
    function PurchaseretunInfo(id) {
        $.ajax({
            type: "get",
            url: "{{ url('Purchase-Return/getView')}}" + '/' + id,
            datatype: ("json"),
            success: function(data) {
               console.log(data); 
    ...
    function lodDataBasicInfo(data) {
        ...
        $("#suppliersearch").prop('disabled', true);
    }
    ...
    function loadTableDetails(data) {
        ...
        data.p_details.forEach(function(value) {
            ...
            var itemdiscount = (value.discount) / value.qty
            $(".data-table tbody").append("<tr id=" + sl + " data-discount='" + itemdiscount + "' data-mrp='" + value.mrp + "' data-unitid='" + value.unit_id + "'>" +
                "<td>" + sl + "</td>" +
                ...
                "<td align='right'>" + value.tp.toFixed(2) + "</td>" +
                "<td class='amount' align='right'>" + value.amount.toFixed(2) + "</td>" +
                "<td class='discount' id='" + value.itemdiscount + "' align='right'>" + value.discount.toFixed(2) + "</td>" +
                "<td class='vat' align='right'>" + value.vat.toFixed(2) + "</td>" +
                "<td class='nettotal' align='right'>" + value.nettotal.toFixed(2) + "</td>" +
                "<td>" +
    ...
    function DataInsert() {
        ...
        $.ajax({
            type: "POST",
            url: "{{ route('purchasereturn.update') }}",
            ...
            error: function(data) {
                $("#overlay").fadeOut();
                swal("Ops! Fail To submit", "Data Updated", "error");
                console.log(data);
            }
        });
